  ...
  return (
    <Link to={`/post/${$id}`}>
      <div className="w-full sm:w-56 p-2 shadow-sm bg-[#FAEBD7] transition-all duration-300 ease-in-out transform hover:scale-105 hover:shadow-xl rounded-lg">
        ...
        <h2 className="text-base px-2 font-medium text-[#1E3A5F] hover:text-[#66A5AD] transition-all duration-300">
          {title}
        </h2>
        <p className="text-xs py-1 px-2 font-medium text-[#1E3A5F] hover:text-[#66A5AD] transition-all duration-300">
